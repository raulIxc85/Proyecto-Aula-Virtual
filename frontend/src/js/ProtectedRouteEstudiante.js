...
// maquetado base
import SiderBarEstudiante from './common/components/layout/Sidebar/SideBarEstudiante';
                ...
                render={props =>
                    isAuthenticated ? (
                        (isAuthenticated === true) ? (<div>
                            <SiderBarEstudiante toggleOpen={this.state.toggleOpen} navToggle={this.navToggle} logOut={logOut} />
