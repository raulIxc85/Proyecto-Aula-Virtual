            ...
            <aside className={`main-sidebar px-0 col-12 col-md-3 col-lg-2 ${toggleOpen?'':'open'}`}>
                ...
                <div className="nav-wrapper">
                    <ul className="nav--no-borders flex-column nav">
                        ...
                        <li className="nav-item">
                            <NavLink to="/asignaciones-catedratico" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">assignment</i>
                                </div>
                        ...
                        <li className="nav-item">
                            <NavLink to="/cursos-asignados" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">assignment</i>
                                </div>
                        ...
                        <li className="nav-item">
                            <NavLink to="/cursos-asignados-estudiante" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">assignment</i>
                                </div>
