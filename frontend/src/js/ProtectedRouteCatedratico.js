...
// maquetado base
import SiderBarCatedratico from './common/components/layout/Sidebar/SideBarCatedratico';
                ...
                render={props =>
                    isAuthenticated ? (
                        (isAuthenticated === true) ? (<div>
                            <SiderBarCatedratico toggleOpen={this.state.toggleOpen} navToggle={this.navToggle} logOut={logOut} />
